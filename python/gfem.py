...
class GFEMModel:
    ...
    def _load_perplex_configuration(self):
        ...
        norm_sample_comp = " ".join(map(str, self.norm_sample_comp))
        ...
        try:
            ...
            dataset_configs = {
                "hp02": {
                    "T_melt": 1100,
                    "melt_mod": "melt(HGPH)",
                    "td_data_file": f"{data_dir}/hp02-td",
                    "sl_data_file": f"{data_dir}/hp-sl",
                ...
                "hp11": {
                    "T_melt": 1100,
                    "melt_mod": "melt(HGPH)",
                    "td_data_file": f"{data_dir}/hp11-td",
                    "sl_data_file": f"{data_dir}/hp-sl",
                ...
                "stx21": {
                    "T_melt": "default",
                    "melt_mod": None,
                    "td_data_file": f"{data_dir}/stx21-td",
                    "sl_data_file": f"{data_dir}/stx21-sl",
                    "em_exclude": ["ca-pv"],
            ...
            dataset_configs["hp622"]["td_data_file"] = f"{data_dir}/hp622-td"
            dataset_configs["hp633"]["td_data_file"] = f"{data_dir}/hp633-td"
            ...
            oxides = [oxides_list[key] for key in oxides_list if key in ox_gfem]
            oxides_string = "\n".join(oxides)
            if perplex_db not in ["hp11", "hp622", "hp633"]:
            ...
            if "hp" in perplex_db:
                build_string = (f"{sid}\ntd-data\nbuild-options\nN\n2\nN\nN\nN\n"
                                ...
                                f"{em_exclude}\n\nY\nsolution-models\n{sl_include}\n\n"
                                f"{sid}\n")
                werami_target_string = (f"{sid}\n2\n36\n1\n{self.fluid_properties}\n"
                                        f"N\n\n2\n7\n{self.melt_mod}\n24\n0\nN\n\n5\n0\n")
                werami_phase_string = (f"{sid}\n2\n25\nN\n{self.fluid_assemblages}\n"
                                       f"N\n\n0\n")
            ...
            self.werami_phase_string = werami_phase_string
            self.werami_target_string = werami_target_string
        except Exception as e:
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    ...
    #++++++++++++++++++++++++++++++++++++++++++++++++++++++
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    # write perplex td data !!
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    def _write_perplex_td_data(self):
        """
        """
        td_data_file = self.td_data_file
        sl_data_file = self.sl_data_file
        model_out_dir = self.model_out_dir

        try:
            shutil.copy(td_data_file, f"{model_out_dir}/td-data")
            shutil.copy(sl_data_file, f"{model_out_dir}/solution-models")
        except Exception as e:
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print(f"!!! ERROR in _write_perplex_td_data() !!!")
            print(f"{e}")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            traceback.print_exc()
            return None
    ...
    def _write_perplex_build_options(self):
        ...
        try:
            ...
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print(f"!!! ERROR in _write_perplex_build_options() !!!")
            print(f"{e}")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            traceback.print_exc()
            return None
    ...
    def _write_perplex_build_config(self):
        ...
        try:
            ...
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print(f"!!! ERROR in _write_perplex_build_config() !!!")
            print(f"{e}")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            traceback.print_exc()
            return None
    ...
    def _write_perplex_vertex_config(self):
        ...
        try:
            ...
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print(f"!!! ERROR in _write_perplex_vertex_config() !!!")
            print(f"{e}")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            traceback.print_exc()
            return None
    ...
    def _write_perplex_werami_config(self):
        ...
        perplex_db = self.perplex_db
        model_out_dir = self.model_out_dir
        werami_phase_string = self.werami_phase_string
        werami_target_string = self.werami_target_string

        try:
            with open(f"{model_out_dir}/werami-targets", "w") as file:
                file.write(werami_target_string)
            with open(f"{model_out_dir}/werami-phases", "w") as file:
                file.write(werami_phase_string)
        except Exception as e:
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print(f"!!! ERROR in _write_perplex_werami_config() !!!")
            print(f"{e}")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            traceback.print_exc()
            return None
    ...
    def _write_perplex_werami_geotherm_configs(self):
        ...
        try:
            ...
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print(f"!!! ERROR in _write_perplex_werami_geotherm_configs() !!!")
            print(f"{e}")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            traceback.print_exc()
            return None
    ...
    def _write_perplex_pssect_config(self):
        ...
        try:
            ...
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            print(f"!!! ERROR in _write_perplex_pssect_config() !!!")
            print(f"{e}")
            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            traceback.print_exc()
            return None
