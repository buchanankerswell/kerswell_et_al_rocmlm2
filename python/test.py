...
#    model = GFEMModel("hp633", f"sm014-loi001", "assets/data/synth-mids.csv", res=32)
#    model.build_model()
...
#    gfems = {}
#    sources = {"m": "assets/data/synth-mids.csv"}
...
#    for model in rocmlms: compose_rocmlm_plots(model)
    ...
    model = GFEMModel("hp633", f"sm000-loi000", "assets/data/synth-mids.csv", res=64)
    ...
    profile = pd.read_csv("assets/data/hymatz-1573K-Pyrolite-0H2O", sep="\t")
